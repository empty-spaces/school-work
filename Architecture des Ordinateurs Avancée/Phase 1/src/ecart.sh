...
# Script calculant l'écart-type d'une serie de valeur.
# Source : https://github.com/ANTsX/ANTs/blob/master/Scripts/antsbashstats.sh
...
echo "Nombre de warmups: $NB_WARMUPS"
echo "$NB_WARMUPS;$std_dev" >> data.csv
echo
# ======================================================= #
